 ...
 * parameter to the GD_nslookup() \ss_function.
 *
 ...
 * 
 * Pass a reference to a \ss_function of this type as the <tt>callback</tt>
 * parameter to the GD_nslookupEx() \ss_function.
 *
 ...
 * \ss_function always takes one of these values.
 */
 ...
 * enterprise management console, then an empty string is passed to the callback
 * instead. If an error occurred, then <tt>NULL</tt> is passed.
 *
